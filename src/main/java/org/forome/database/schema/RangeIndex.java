...
public class RangeIndex extends BaseIntervalIndex {
    ...
    public RangeIndex(org.forome.database.anotation.RangeIndex index, StructEntity parent) {
    ...
    private static List<Field> buildIndexedFields(org.forome.database.anotation.RangeIndex index, StructEntity parent) {
