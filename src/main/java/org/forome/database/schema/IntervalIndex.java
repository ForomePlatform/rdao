...
public class IntervalIndex extends BaseIntervalIndex {
    ...
    public IntervalIndex(org.forome.database.anotation.IntervalIndex index, StructEntity parent) {
    ...
    private static List<Field> buildIndexedFields(org.forome.database.anotation.IntervalIndex index, StructEntity parent) {
